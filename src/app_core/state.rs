...
const WELCOME_DETAILS_LINES: &[&str] = &[
    ...
    "  • Click any property value to add it to your filter",
    "  • Ctrl+Click a property value to jump straight to its ID",
    "\n",
    "Search Syntax:",
    ...
    "\n",
    "Command line:",
    "  • --source C-BN/data/json   : load JSON from game source folder",
    "  • --game 2026-01-02         : load specific game release version",
    "  • --help",
];
